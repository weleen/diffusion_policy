...
def get_agent(device: str):
    ...
    # 1. Load hydra config
    train_dir = "/mnt/dongxu-fs1/data-ssd/yiming/project/MyProjects/LightVLA/third_party/dp2rss_fork/data/outputs/pruned/2025.05.13/0/"
    ...
    weight_paths.sort()
    print(weight_paths)
    weight_path = os.path.join(train_dir, "checkpoints", "latest.ckpt")
